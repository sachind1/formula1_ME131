...
class image_processing_node():
    ...
    def calc_x_newPixel_to_y_Inertial(self,x_newPixel,y_newPixel):
        ...
        y_Inertial = x_newPixel*0.0083285+0.004478
    ...
    def calc_y_newPixel_to_x_Inertial(self,y_newPixel):
        ...
        x_Inertial = (2.2534*10**-8)*y_newPixel**4+(-5.1008*10**-6)*y_newPixel**3+(2.7176*10**-4)*y_newPixel**2+0.0187*y_newPixel
    ...
    def compute_uOpt(self,x_ref,y_ref,v_ref):
		...
		int = psi_des + beta_des

                Ac = np.matrix([[0, 0, -v_ref*sin(int)], [0, 0, v_ref*cos(int)],[0, 0, 0]]); # TO DO

                Bc = np.matrix([[cos(int), -v_ref*sin(int)],[sin(int), v_ref*cos(int)],[sin(beta_des)/lr, v_ref*cos(v_ref)/lr]]); # TO DO

                Q = np.matrix([[10, 0, 0],[0, 10, 0],[0, 0, 1]]); # TO DO

                R = np.matrix([[0.01, 0],[0, 0.1]]); # TO DO
